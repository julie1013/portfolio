...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready(function () {
	  ...
	  __webpack_require__(25).registerPaths();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var router5 = __webpack_require__(4);
	var loggerPlugin = __webpack_require__(4).loggerPlugin;
	var browserPlugin = __webpack_require__(21).default;

	var routes = [{ name: 'index', path: '/' }, { name: 'about', path: '/about' }, { name: 'projects', path: '/projects' }];

	var options = {
	  defaultRoute: 'index'
	};

	var router = router5.createRouter(routes, options).usePlugin(loggerPlugin).usePlugin(browserPlugin({
	  useHash: true,
	  hashPrefix: '!'
	}));

	router.useMiddleware(__webpack_require__(24).transition);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createRouter = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routerLifecycle = __webpack_require__(10);
	...
	var _routeLifecycle = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hamburgerCross = function hamburgerCross() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = router.rootNode.children.map(function (route) {
	  return route.name;
	});

	var registerPaths = function registerPaths() {
	  routes.forEach(function (route) {
	    $('a[href="#' + route + '"]').on('click', function (event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// imports
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Mountains+of+Christmas);", ""]);
...
<<<<<<< HEAD
	module.exports = __webpack_require__.p + "bc986ae1b9c70b6b30d6afd0a29a8ad0.jpg";
=======
	module.exports = __webpack_require__.p + "a7e7544ee691c1a9592ef5180dbb267a.jpg";
>>>>>>> master
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(39);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
